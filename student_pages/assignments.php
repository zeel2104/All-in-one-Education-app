...
<div id="notheader"><br>
    ...
    $result = mysqli_query($conn,"SELECT ac.courses, asgn.description, asgn.filepath, asgn.due_date, asgn.filepath, asgn.created, asgn.id ,asgn.name
                                        from academics ac left join assignments asgn on ac.teacher_id=asgn.tch_id 
                                        where ac.st_id='$stud_id' and asgn.description is NOT null group by asgn.name;");
...
<th scope=\"col\">Action</th>
    ...
    if ($files[$a] == $fname) {
        ...
        echo "<td>" . $row['name'] . "</td>";
    echo "<td>"?><a download="<?php echo $files[$a] ?>" href="../teacher_pages/uploads/<?php echo $files[$a] ?>"><?php echo $files[$a] ?></a></td>
    <?php
        echo "<td>" . $row['due_date'] . "</td>";
        echo "<td><button class='btn btn-info'><a style='color: white' href='submit_assignment.php?send=" .$assgnid."'>$buttontext</a></button><span style=\"color:". $colorMap[$msg]."\"><i> $msg</i></span></td>";
