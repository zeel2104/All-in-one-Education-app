...
<head>
    ...
    <df-messenger
            intent="WELCOME"
            chat-title="edubot"
            agent-id="8e7f3398-e1d2-450b-bc08-3998e4239dcc"
            language-code="en"
    ></df-messenger>
</head>
<body>
<?php
$result=mysqli_query($conn, "Select * from student where st_mail='$studid'");
while($row= mysqli_fetch_array($result)){
    $name=$row['st_name'];
    $email=$row['st_mail'];
}
$today_date=date("Y-m-d h:i:sa");
$sql=mysqli_query($conn,"select * from students_todo_list where due_date>='$today_date' and st_mail='$studid'");
$tasks=mysqli_num_rows($sql);


$res2=mysqli_query($conn, "select * from academics where st_id='$studid'");
$teachers=mysqli_num_rows($res2);

//$res3=mysqli_query($conn,"select * from exams where st_mail='$studid'");
//$exams=mysqli_num_rows($res3);
?>
<header id="header">
    <div class="container">
    ...
    <div class="row">
        <div class="col-lg-3" style=" ]height: 200px">
            <div class="card card-counter primary">
                ...
                <span class="count-numbers"><?php echo $tasks?></span>
      ...
      <!--  <div class="col-md-3">
            <div class="card card-counter info">
                ...
                <span class="count-numbers"><?php echo $exams?></span>
                <span class="count-name">Exams</span>
            </div> -->
       <div class="col-md-3">
            <div class="card card-counter info">
                <i class="fa fa-ticket"></i>
