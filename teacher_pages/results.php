...
$res4=mysqli_query($conn,"select * from exams where exam_id='$examid'");
while($row4=mysqli_fetch_array($res4)){
    $examname=$row4['exam_name'];
...
<div id="notheader"><br>
    <h3>Results for <?php echo $examname?></h3><br>
    <form method="post" action="exportcsv.php?id=<?php echo $examid?>" align="center">
        <input type="submit" name="export" value="Export Results" class="btn btn-primary pull-right" />
    </form>
    <?php
    $colorMap['pending'] = '#ff3333'; //red
    $colorMap['submitted'] = '#00b359'; //green

    $result = mysqli_query($conn,"SELECT res.course, res.stud_id, res.exam_name, res.marks_scored, res.total_marks, res.percentage 
                                        from student_report res left join exams ex 
                                        on res.exam_id=ex.exam_id 
                                        where ex.teacher_email='$tid' and res.exam_id='$examid' GROUP by res.stud_id;");
