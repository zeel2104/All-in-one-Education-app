...
?>
    ...
    <div id="notheader">
        ...
        if (isset($_POST["submit"])) {
            ...
            $end_event = $_POST['end'];
            echo $task;
            $result2 = mysqli_query($conn, "Insert into teachers_todo_list (teacher_email,task,start_date,due_date) Values ('$teacher','$task','$start_event','$end_event')");
            if ($result2) {
                echo "success";
            } else {
                echo "not success";
                ...
                <div class="card">
                    ...
                    <div class="list-group">
                        <ul style="list-style: none">
                            <?php
                            $res5=mysqli_query($conn,"select * from teachers_todo_list where teacher_email='$teacher'");
