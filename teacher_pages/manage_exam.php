            ...
            <div class="about-content col-lg-12">
                ...
                <div class="link-nav">
						<span class="box">
							...
							<a href="courses.php">Manage Exam</a>
						</span>
                </div>
            </div>
        </div>
...
if(isset($_GET["del"])){
    $exam_name = $_GET["del"];
    $delexam=mysqli_query($conn, "DELETE FROM exams WHERE exam_name='$exam_name'" );
    if($delexam){
...
$result = mysqli_query($conn,"select * from exams where teacher_email='$teacherid'");
...
<th scope=\"col\">Action</th>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td><button class='btn btn-danger'><a style='color: white' href='manage_exam.php?del=".$row["exam_name"]."'>Delete</a></button>
                <button class='btn btn-dark'><a style='color: white' href='add_ques.php?get=".$row["exam_name"]."'>Manage</a></button>
                <button class='btn btn-primary'><a style='color: white' href='results.php?examid=".$row["exam_id"]."'>View Result</a></button></td>";
    }
    echo "</table>";
?>
</div>
